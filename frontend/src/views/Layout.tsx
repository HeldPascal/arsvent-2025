            ...
            <div className="topbar-actions row menu-container" ref={menuRef}>
              ...
              {menuOpen && (
                <div className="menu-popover">
                  ...
                  <button className="ghost nav-link" onClick={() => closeMenuAnd(() => navigate("/prizes"))}>
                    {t("prizesTitle")}
                  </button>
                  ...
                  {user.isAdmin || user.isSuperAdmin ? (
                    <button className="ghost nav-link" onClick={() => closeMenuAnd(() => navigate("/admin/prizes"))}>
                      Prize management
                    </button>
                  ) : null}
                  {user.isAdmin || user.isSuperAdmin ? (
                  ...
                  {user.isAdmin || user.isSuperAdmin ? (
                    <button className="ghost nav-link" onClick={() => closeMenuAnd(() => navigate("/admin/settings"))}>
                      Admin settings
                    </button>
                  ) : null}
