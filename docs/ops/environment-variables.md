...
| `READY_TIMEOUT_SECONDS` | Readiness timeout in seconds. | `60` | Deploy fails after this threshold. |
| `READY_INTERVAL_SECONDS` | Readiness poll interval in seconds. | `2` | Lower values increase load on backend. |
